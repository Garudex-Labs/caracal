...
class RegisteredTool(Base):
    ...
    tool_type = Column(String(32), nullable=False, default="direct_api", server_default="direct_api")
    handler_ref = Column(String(512), nullable=True)
    mapping_version = Column(String(128), nullable=True)
    allowed_downstream_scopes = Column(JSON, nullable=False, default=list, server_default=text("'[]'"))
