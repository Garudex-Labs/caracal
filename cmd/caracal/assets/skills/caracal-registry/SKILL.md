...
- Search with the user's natural-language terms, then narrow by type, namespace, harness, or category only when useful.
...
- Project members can see their project's shared items. Use `NAMESPACE/ITEM_SLUG` for direct references.
