...
name: caracal-ops
command: caracal
description: "Inspects Caracal traces, sessions, rankings, telemetry health, logs, and Agent insight reports. Use when the user wants operational evidence, current activity, telemetry diagnosis, report generation, regression analysis, or recommendations grounded in Agent usage."
version: 2.4.0
owner: caracal
---
...
6. Verify report generation results.
...
8. After an uncertain report-generation failure, read current state before retrying.

## Choose the workflow

| User intent | Read |
| --- | --- |
| Sessions, traces, rankings, telemetry, or logs | [Operational workflows](references/operational-workflows.md) |
