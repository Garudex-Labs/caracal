...
```bash
caracal ops insights list NAMESPACE/AGENT_SLUG --output json
caracal ops insights show NAMESPACE/AGENT_SLUG latest --output json
```
...
```bash
caracal ops insights generate NAMESPACE/AGENT_SLUG --period 14 --wait --output json
caracal ops insights generate NAMESPACE/AGENT_SLUG --version 1.2.0 --compare 1.1.0 --period 30 --wait --output json
```
...
```bash
caracal ops insights show NAMESPACE/AGENT_SLUG latest --section at_a_glance --output json
caracal ops insights show NAMESPACE/AGENT_SLUG latest --section friction_analysis --output json
caracal ops insights show NAMESPACE/AGENT_SLUG latest --section suggestions --output json
caracal ops insights show NAMESPACE/AGENT_SLUG latest --section usage_cost_analysis --output json
caracal ops insights show NAMESPACE/AGENT_SLUG latest --section version_comparison --output json
caracal ops insights show NAMESPACE/AGENT_SLUG latest --section regression_detection --output json
```
