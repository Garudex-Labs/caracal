...
Complete [Harden Security Posture](/security/hardening/), [Generate an Evidence Pack](/security/evidence-pack/), and [Hand Off to Platform Teams](/operations/platform-team-handoff/).