...
Keep private until fix/mitigation or coordinated outcome. For active exploitation, contain with [Respond to Incidents](/operations/incident-response/).

## Next Step

Review [Review the Threat Model](/security/threat-model/).
