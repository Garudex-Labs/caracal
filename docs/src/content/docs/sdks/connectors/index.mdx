...
| [Redis Token State](/sdks/connectors/redis/) | `@caracalai/revocation-redis`, `caracalai-revocation-redis`, Go Redis connector | Shared revocation state and revocation stream consumption. |
