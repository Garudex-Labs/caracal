...
| Admin or provisioning automation     | [Admin Package](./admin/)                            | [Use the Admin API](/api/control-plane/)                                                              |
...
Go submodules may resolve to pseudo-versions because release tags at the repository root are not per-module tags for nested Go modules. Adapter availability is intentionally ecosystem-specific; parity covers behavior exposed by all three application facades, not identical framework packages.

## Related Guides

- [Add SDK to Your App](/get-started/add-sdk-to-your-app/)
- [Make Runs Identifiable with Labels](/tutorials/connect-an-agent/)
