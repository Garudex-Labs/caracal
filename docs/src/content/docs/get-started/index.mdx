...
The onboarding path deliberately keeps product management in the Console and local runtime lifecycle in the `caracal` shell:
...
| Integrating an app or agent | [Welcome](./welcome/) → [First Integration](./first-integration/) → [Tutorials](/tutorials/) | SDK code that opens an agent run and calls a Gateway-protected resource. |
