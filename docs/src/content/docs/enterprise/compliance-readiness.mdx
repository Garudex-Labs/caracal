...
| R3   | Delegation is constrained and re-validated           | <span className="status status-covered">Covered</span>           | Delegations re-validated server-side as subsets; cross-application delegation requires receiver consent.                    |
