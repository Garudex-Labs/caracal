...
| `caracal config <set\|get\|unset\|list\|path\|edit>`         | `0` after the read or write succeeds.                                                                | `1` on an unknown subcommand, an invalid variable name, or `get` of an unset variable.                                |
