...
| `agent_identity_required`          | A verifier requires an agent identity.                                                                           | In-process verifier or verify engine.                             | Run the call from a Session, not a bare Authority record.                                                                                                       |
