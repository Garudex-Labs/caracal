...
| Module | Import path |
| --- | --- |
| Core | `github.com/garudex-labs/caracal/core` |
| SDK | `github.com/garudex-labs/caracal/sdk` |
| net/http connector | `github.com/garudex-labs/caracal/connectors/nethttp` |
| Redis connector | `github.com/garudex-labs/caracal/connectors/redis` |
