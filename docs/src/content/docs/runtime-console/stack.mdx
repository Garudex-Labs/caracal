...
After a full purge, recreate product state through the web console: zones, applications, providers, resources, policies, Control keys, and generated runtime profiles.
