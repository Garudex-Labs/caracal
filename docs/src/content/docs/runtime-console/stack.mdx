...
The stack is the set of containers `caracal up` manages: Caracal's services, PostgreSQL, Redis, and the packaged web console. This page covers its day-to-day lifecycle; [Install Caracal](/get-started/install-caracal/) covers getting the CLI and Docker in place.
