...
After a full purge, recreate product state through the Console: zones, applications, providers, resources, policies, grants, Control keys, and generated runtime profiles.
