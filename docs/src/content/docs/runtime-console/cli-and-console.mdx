...
description: Side-by-side reference for runtime CLI commands and Console-owned workflows.
pageType: reference
---

Use this page when you need to decide whether an action belongs in the runtime CLI, the Console, or an API client.
