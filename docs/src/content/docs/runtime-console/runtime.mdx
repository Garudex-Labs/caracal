...
Web console **Guided setup** is the recommended way to create the first zone, application, resource, and policy; the application's one-time client secret is shown once at creation.
