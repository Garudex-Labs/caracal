...
`pnpm run setup` installs Node workspace dependencies, downloads Go module dependencies, creates `.venv`, installs Python test and style tools, and installs local Python packages in editable mode.
