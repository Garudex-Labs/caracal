...
The control service is pre-release and disabled by default. Start it explicitly with Docker Compose's `control` profile after setting its authentication variables:
