...
Rotate one class at a time. Inventory the KEK, zone signing keys, integrity HMACs, idempotency HMAC, Gateway-STS HMAC, service tokens, storage credentials, and web auth secret.
...
Verify [PostgreSQL](/operations/postgres/) and [Redis Streams](/operations/redis/).
