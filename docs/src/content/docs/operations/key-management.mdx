...
| --- | --- | --- |
| `SECRET_STORE_KEK` | API and STS after re-encrypting stored envelopes under the new key. | Provider credentials decrypt and STS can read active signing material. |
