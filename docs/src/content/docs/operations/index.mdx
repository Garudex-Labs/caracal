...
| Kubernetes platform team | [Kubernetes with Helm](/operations/kubernetes-helm/) |
...
| SRE/on-call | [Observability and Health](/operations/observability/), [Alerting Recipes](/operations/alerts/), and [Failure Modes and Recovery](/operations/failure-modes/) |
...
- Product-management operations happen through Console, Admin SDK, or Control API; the top-level runtime shell only manages local lifecycle and `caracal run`.
...
| Recovery | [Failure Modes and Recovery](/operations/failure-modes/), [Backup and Retention](/operations/backup-retention/), and [Incident Response](/operations/incident-response/) |
