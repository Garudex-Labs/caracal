...
| Variable | Purpose |
| --- | --- |
| `CARACAL_PRIVATE_EGRESS_HOSTS` | Comma-separated hosts on private address ranges that subject-issuer JWKS and provider token endpoints may reach; empty blocks private-range egress. |
