...
| `ISSUER_URL` | — | **Required.** STS issuer URL (same as `ISSUER_URL` in STS) |
| `AGENT_COORDINATOR_AUDIENCE` | — | **Required.** JWT audience the Coordinator accepts (e.g., `caracal.coordinator`) |
