...
| `API_OPERATOR_SELF_GOVERN` | no | `false` | Lets the Operator self-govern the `caracal.sys` system zone; requires the Control plane. Role credentials are generated and rotated autonomously. |
