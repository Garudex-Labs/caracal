...
Caracal publishes signals and Helm controls, but no universal throughput, latency, or availability figure. Establish a baseline with your workload. For measured reference results from the v0.2.0 validation under stated test conditions, see [Performance and Scalability](/operations/performance-benchmarks/).
