...
Use this for infrastructure changes. Policy activation has a separate [Policy Deployment](/operations/policy-deployment/) procedure.
...
Complete [Platform Handoff](/operations/platform-team-handoff/).
