...
| Authority | `sessions`, `delegated_grants`, `provider_grants`, `step_up_challenges`, `secrets` |
...
| Operations | `event_outbox`, `caracal_outbox`, `admin_tokens`, `gateway_resource_bindings`, `gateway_binding_revision` |
