...
description: Complete reference for the caracal terminal interface and caracal-terminal terminal interface — stack management, admin operations, runtime token injection, and observability.
pageType: landing
---
...
Errors are written to stderr. Exit code `0` indicates success; `1` indicates a terminal interface or API error.
