...
Use [Use Coordinator API](/api/coordinator/) for routes and SDK contracts. Service environment variables are cataloged in [Configure Service Environment](/operations/env-vars/).
...
[Issue Mandates](/services/sts/) for the authority path, [Coordinate Sessions](/architecture/delegation-flow/) for the cross-service flow, or [Manage Runtime Authority](/runtime-console/agents/) for the operator workflow.
