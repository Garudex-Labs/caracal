...
Use [Use Coordinator API](/api/coordinator/) for routes and SDK contracts.
...
[Coordinate Sessions](/architecture/delegation-flow/) for the cross-service flow or [Manage Runtime Authority](/runtime-console/agents/) for the operator workflow.
