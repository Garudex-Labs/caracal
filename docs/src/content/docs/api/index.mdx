...
| ---------------------------------------- | ------------------- | ------------------------------------------------------------------------------------------------------------------ |
| [Use the Admin API](/api/control-plane/) | API service `/v1`   | Zones, applications, providers, resources, policies, policy sets, grants, sessions, audit, step-up, and templates. |
| [Use Coordinator API](/api/coordinator/) | Coordinator service | Sessions, agent services, invocations, Delegations, and SDK lifecycle endpoints.                                   |
