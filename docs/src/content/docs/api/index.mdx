...
| --- | --- | --- | --- |
| [Control-Plane API](./control-plane/) | 3000 | Manage zones, applications, resources, policies, grants, and sessions | Admin bearer token (Argon2id verified, stored in `admin_tokens`) |
...
| [Gateway](./gateway/) | 8081 | Authenticate and proxy inbound MCP calls to upstream services | Session bearer token issued by STS |
