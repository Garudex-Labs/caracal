...
Validate a policy-set version and optional OPA input fixture without mutating active bindings.
...
The simulation checks policy-set contract, schema compatibility, manifest integrity, and optional input shape. It does not execute STS OPA evaluation.
