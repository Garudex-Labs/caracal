...
Map one Lynx pattern - not the whole domain - onto [Model Your Application in Caracal](/guides/modeling-recipes/) and add equivalent tests to your integration.
