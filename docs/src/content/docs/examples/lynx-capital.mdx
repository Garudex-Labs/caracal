...
| Caracal package | `caracalai-sdk==0.1.4rc1`. |
...
| `/overview/about` | First overview page: what Lynx Capital is. |
| `/overview/architecture` | Second overview page: app and provider shape. |
| `/overview/notice` | Third overview page: demo notice and setup acknowledgement. |
