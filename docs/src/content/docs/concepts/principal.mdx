...
Applications have registration metadata, a credential type, optional runtime traits, and optional DCR expiry. Managed applications are operator-provisioned for known durable software; dynamically registered applications are created through the zone DCR endpoint for self-service, high-churn, or ephemeral clients.
