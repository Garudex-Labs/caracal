...
Use this page to choose where Caracal makes and enforces an authorization decision. First understand [Caracal Mental Model](/concepts/model-overview/).
...
sequenceDiagram
  ...
  STS->>OPA: Evaluate Application, Session, grant data, Resource, Delegation
  OPA-->>STS: allow, deny, diagnostics, or Approval requirement
