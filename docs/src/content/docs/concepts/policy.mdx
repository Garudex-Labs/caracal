...
Every evaluation receives documented Application, Resource, action, Session, Delegation, requested-scope, Subject-claim, Approval, and trace context. Use [Author Policy Data](/guides/author-policy/) for the current field-level contract.
