...
- Onboarding uses the web console guided setup to create the first zone, application, resource, and policy, then you bind launch credentials on the console's Run page and give the workload its application ID and client secret.
