...
- Onboarding uses the web console guided setup to create the first zone, application, resource, and policy, then you bind launch credentials in the application's Run section and give the workload its application ID and client secret.
