...
description: Resource, TTL, hop, budget, and approval restrictions that travel with a Delegation.
sidebar:
  order: 11
---

Typed constraints make delegated authority explicit. They are stored on Delegations and evaluated by policy, SDK context, and resource-server verification.
