...
description: Use the audit trail and decision trace to explain exactly why a
  request was allowed or denied.
pageType: workflow
slug: v0.2/tutorials/inspect-a-run
---
