---
title: Tutorials
description: A guided journey from the Get Started agent flow to a protected
  real API, identifiable app runs, self-serve debugging, and a chosen production
  path.
pageType: workflow
slug: v0.2/tutorials
---

In [Get Started](/v0.2/get-started/) your agent made one protected call to an LLM provider and you proved the full enforcement path. Tutorials make that setup yours. Working through them in order, you will:
...
* the working SDK example and `caracal.toml` profile from [Add SDK to Your App](/v0.2/get-started/add-sdk-to-your-app/).

:::note
If any prerequisite is missing, return to [Get Started](/v0.2/get-started/). Tutorials assume the evaluator stack already works.
:::

## After Tutorials

Use [Guides](/v0.2/guides/) for task-specific implementation details, [SDKs](/v0.2/sdks/) for package APIs, and [Concepts](/v0.2/concepts/) when you need the reference model behind policy, delegation, revocation, or audit.
