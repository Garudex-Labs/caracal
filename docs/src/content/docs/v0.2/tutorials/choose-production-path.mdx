...
description: Pick the one enforcement boundary that matches your deployment,
  then follow its implementation guide.
pageType: workflow
slug: v0.2/tutorials/choose-production-path
---
...
| --- | --- |
| Route HTTP traffic through the Caracal Gateway | [Protect a Gateway-Routed HTTP API](/v0.2/guides/protect-gateway-http/) |

**In-process adapter** - your service verifies mandates itself:

| If your production path is... | Continue with |
| --- | --- |
| Protect an Express resource server in process | [Protect an Express App](/v0.2/guides/protect-express/) |
| Protect a FastAPI or Starlette service in process | [Protect a FastAPI App](/v0.2/guides/protect-fastapi/) |
| Protect a FastMCP server in process | [Protect a FastMCP App](/v0.2/guides/protect-fastmcp/) |
| Protect a Go `net/http` service in process | [Protect a Go net/http Service](/v0.2/guides/protect-nethttp/) |
| Protect an MCP server without a dedicated adapter | [Protect an MCP Server](/v0.2/guides/protect-mcp/) |
...
| --- | --- |
| Add Caracal sessions and Gateway calls to app code | [TypeScript SDK](/v0.2/guides/sdk-typescript/), [Python SDK](/v0.2/guides/sdk-python/), or [Go SDK](/v0.2/guides/sdk-go/) |
| Launch an existing CLI or worker with injected provider credentials | [Run an Agent with caracal run](/v0.2/guides/runtime-run/) |
...
| --- | --- |
| Model zones, apps, resources, and customer boundaries | [Model Your Application in Caracal](/v0.2/guides/modeling-recipes/) |
| Configure provider credentials or OAuth | [Define Resources and Providers](/v0.2/guides/resources-providers/) and [Provider Recipes](/v0.2/guides/provider-recipes/) |
| Debug denies or unexpected allows | [Debug Authorization Decisions](/v0.2/guides/authorize-access/) |
| Hand narrowed authority between agents | [Implement Multi-Agent Delegation](/v0.2/guides/delegation/) |
| Export or query audit evidence | [Tail and Query the Audit Stream](/v0.2/guides/audit-stream/) |
| Hold sensitive actions for human approval | [Human Approval](/v0.2/guides/step-up/) |
...
| Platform engineer | [Production Integration Patterns](/v0.2/guides/production-patterns/), then operations pages. |
| Security reviewer | [Debug Authorization Decisions](/v0.2/guides/authorize-access/), [Audit and Request Traces](/v0.2/concepts/audit-ledger/), and [Review the Threat Model](/v0.2/security/threat-model/). |
| Policy owner | [Author Policy Data](/v0.2/guides/author-policy/) and [Activate a Policy Set](/v0.2/guides/activate-policy-set/). |
...
Open [Guides](/v0.2/guides/) and follow the path that matches your boundary.
