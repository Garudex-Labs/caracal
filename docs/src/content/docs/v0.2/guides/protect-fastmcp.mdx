...
description: Verify Caracal mandates in a FastMCP server so tool calls are
  checked before handlers run.
slug: v0.2/guides/protect-fastmcp
---
...
For exact call signatures, use [FastMCP Adapter reference](/v0.2/sdks/adapters/fastmcp/).

## Next Step

Use [Protect an MCP Server](/v0.2/guides/protect-mcp/) only when the framework hook cannot use this dedicated adapter.
