...
description: Add the caracalAuth middleware to Express routes to verify mandates
  and enforce scope requirements.
slug: v0.2/guides/protect-express
---
...
For middleware option signatures, use [Express Adapter reference](/v0.2/sdks/adapters/express/).

## Next Step

Add route-specific requirements, then test the boundary with [Test Caracal Integrations](/v0.2/guides/testing/).
