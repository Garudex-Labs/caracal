...
description: Configure a resource route so Caracal Gateway verifies mandates,
  brokers provider credentials, forwards the request, and records action-result
  audit.
slug: v0.2/guides/protect-gateway-http
---
...
For in-process enforcement, use [Protect an Express App](/v0.2/guides/protect-express/), [Protect a FastMCP App](/v0.2/guides/protect-fastmcp/), [Protect a Go net/http Service](/v0.2/guides/protect-nethttp/), or [Protect an MCP Server](/v0.2/guides/protect-mcp/).
...
Use [Define Resources and Providers](/v0.2/guides/resources-providers/) for field definitions and [Provider Recipes](/v0.2/guides/provider-recipes/) for concrete OpenAI, Google, GitHub, Slack, and internal API examples.
...
Run [Check Provider Readiness](/v0.2/examples/provider-preflight/), then use [Debug Authorization Decisions](/v0.2/guides/authorize-access/) for any deny.
