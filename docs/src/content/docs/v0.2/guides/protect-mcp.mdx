...
description: Gate MCP tool calls with Caracal mandate verification using the
  framework-neutral verify packages.
slug: v0.2/guides/protect-mcp
---
...
For exact verifier functions and error types, use [Verify Package reference](/v0.2/sdks/verify/).

## Next Step

Wrap the framework hook, then run [Test Caracal Integrations](/v0.2/guides/testing/) with a revoked-anchor case.
