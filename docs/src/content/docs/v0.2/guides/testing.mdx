...
description: Fake the coordinator and STS behind injected HTTP clients, assert
  on emitted events, and run integration tests against a local runtime.
slug: v0.2/guides/testing
---
...
Related pages: [Integrate the TypeScript SDK](/v0.2/guides/sdk-typescript/), [Integrate the Python SDK](/v0.2/guides/sdk-python/), and [Integrate the Go SDK](/v0.2/guides/sdk-go/).
...
Add acceptance cases to deployment gating, then use [Debug Authorization Decisions](/v0.2/guides/authorize-access/) for any runtime-only difference.
