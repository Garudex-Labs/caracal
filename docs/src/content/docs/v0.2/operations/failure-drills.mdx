...
description: Rehearse one bounded failure at a time and measure detection and
  recovery without claiming resilience.
pageType: workflow
slug: v0.2/operations/failure-drills
---
...
4. Remove the fault.
5. Execute [Recover from Failures](/v0.2/operations/failure-modes/).
...
Update thresholds/runbooks, then validate [Back Up and Retain Data](/v0.2/operations/backup-retention/).
