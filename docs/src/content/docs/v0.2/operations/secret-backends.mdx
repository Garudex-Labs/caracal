...
description: Select and verify the implemented backend for user-entered
  credential envelopes.
pageType: workflow
slug: v0.2/operations/secret-backends
---
...
Plan dependent rotations in [Rotate Keys and Secrets](/v0.2/operations/key-management/).
