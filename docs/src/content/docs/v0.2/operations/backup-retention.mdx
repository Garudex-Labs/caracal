...
description: Back up and destructively restore the shipped Compose stack with
  separate secret custody.
pageType: workflow
slug: v0.2/operations/backup-retention
---
...
Use [Respond to Incidents](/v0.2/operations/incident-response/) after data loss or tampering.
