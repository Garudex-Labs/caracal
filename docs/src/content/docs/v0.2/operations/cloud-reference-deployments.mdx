...
description: Adapt the External Secrets and Helm examples without treating them
  as provider-certified deployments.
pageType: workflow
slug: v0.2/operations/cloud-reference-deployments
---
...
Apply [Harden Production](/v0.2/operations/tls-hardening/) before admitting traffic.
