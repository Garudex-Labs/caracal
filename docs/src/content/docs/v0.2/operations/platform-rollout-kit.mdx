...
description: Gate version, configuration, network, secret, and chart changes on
  measurable safety checks.
pageType: workflow
slug: v0.2/operations/platform-rollout-kit
---

Use this for infrastructure changes. Policy activation has a separate [Deploy Policy Changes](/v0.2/operations/policy-deployment/) procedure.
...
Complete [Hand Off to Platform Teams](/v0.2/operations/platform-team-handoff/).
