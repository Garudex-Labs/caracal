...
description: Run migrations, verify schema protections, monitor capacity, and
  recover the durable store.
pageType: workflow
slug: v0.2/operations/postgres
---
...
Verify event delivery with [Operate Redis Streams](/v0.2/operations/redis/).
