...
description: Package the open-source deployment assets, operator inputs,
  runbooks, and acceptance evidence.
pageType: workflow
slug: v0.2/operations/install-kit
---
...
Use [Plan a Platform Rollout](/v0.2/operations/platform-rollout-kit/) for deployment and [Hand Off to Platform Teams](/v0.2/operations/platform-team-handoff/) for ownership acceptance.
