...
pageType: workflow
slug: v0.2/operations/alerts
---

Configure alerts after [monitoring](/v0.2/operations/observability/) is scraping and before production traffic, so failures page someone instead of waiting to be noticed. Use the chart PrometheusRule only with a compatible rule importer. Tune thresholds from measured behavior.
...
Start [Troubleshoot by Symptom](/v0.2/operations/troubleshooting/) or rehearse [Run Failure Drills](/v0.2/operations/failure-drills/).
