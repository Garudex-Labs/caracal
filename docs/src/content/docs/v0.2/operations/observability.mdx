...
description: Gate traffic and changes on verified liveness, readiness, metrics,
  and end-to-end evidence.
pageType: workflow
slug: v0.2/operations/observability
---
...
Route signals with [Configure Alerts](/v0.2/operations/alerts/).
