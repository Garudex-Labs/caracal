...
description: Upgrade the packaged runtime or Helm release with forward-only
  migration and explicit rollback checks.
pageType: workflow
slug: v0.2/operations/upgrade
---
...
Read release notes, use supported sequential upgrades, [back up data and secrets](/v0.2/operations/backup-retention/), record current config, verify audit/streams, and prepare canaries. Install the new runtime binary before upgrading.
...
Record result in [Plan a Platform Rollout](/v0.2/operations/platform-rollout-kit/).
