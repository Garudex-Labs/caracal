...
description: Operate and verify audit ingestion and optional S3-compatible
  export without claiming compliance.
pageType: workflow
slug: v0.2/operations/compliance-audit-integration
---
...
Generate an [Generate an Evidence Pack](/v0.2/security/evidence-pack/) or complete [Hand Off to Platform Teams](/v0.2/operations/platform-team-handoff/).
