...
description: Diagnose an unhealthy deployment from orchestration through
  storage, streams, services, and safety state.
pageType: workflow
slug: v0.2/operations/debugging
---
...
Apply [Recover from Failures](/v0.2/operations/failure-modes/).
