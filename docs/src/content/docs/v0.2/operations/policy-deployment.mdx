...
description: Validate, activate, verify, and recover policy changes through
  product-management surfaces.
pageType: workflow
slug: v0.2/operations/policy-deployment
---
...
Use [Upgrade Caracal](/v0.2/operations/upgrade/) only for runtime/chart/schema changes.
