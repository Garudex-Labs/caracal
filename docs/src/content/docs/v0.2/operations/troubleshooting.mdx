...
description: Triage an application-visible failure and route it to
  authorization, configuration, or infrastructure diagnosis.
pageType: workflow
slug: v0.2/operations/troubleshooting
---
...
1. Check readiness. If any service is NotReady, use [Debug Infrastructure Issues](/v0.2/operations/debugging/).
...
Use [Debug Infrastructure Issues](/v0.2/operations/debugging/) or [Debug Authorization Decisions](/v0.2/guides/authorize-access/).
