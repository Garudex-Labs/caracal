...
description: Start the local protected target that proves Gateway-brokered
  requests reach an upstream service.
pageType: workflow
slug: v0.2/examples/echo-upstream
---
...
Then send a request through the Gateway with the SDK transport from [First Protected Call](/v0.2/get-started/first-protected-call/#the-agents-first-protected-call), pointing it at this resource. With the application identity from guided setup in the environment, the call has this shape:
...
Continue to [Bootstrap Control State](/v0.2/examples/control-bootstrap/) when you want repeatable setup for demo resources and policies.
