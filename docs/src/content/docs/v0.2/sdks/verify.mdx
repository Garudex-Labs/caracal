...
description: Framework-neutral verification engine for bearer parsing, mandate
  verification, and revocation checks.
slug: v0.2/sdks/verify
---
...
* [Express Adapter](/v0.2/sdks/adapters/express/)
* [FastMCP Adapter](/v0.2/sdks/adapters/fastmcp/)
* [Go net/http Adapter](/v0.2/sdks/adapters/nethttp/)
