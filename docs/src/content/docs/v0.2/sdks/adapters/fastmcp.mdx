...
slug: v0.2/sdks/adapters/fastmcp
---
...
There is no Go FastMCP adapter; use the framework-neutral Go verifier or the [net/http adapter](/v0.2/sdks/adapters/nethttp/).

## Boundary

The adapter verifies tokens; it does not create Sessions or Delegations. Use the [Python SDK](/v0.2/sdks/python/) or [TypeScript SDK](/v0.2/sdks/typescript/) to create Caracal context before making outbound calls.
