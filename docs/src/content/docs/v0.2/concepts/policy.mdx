...
description: Versioned policy data documents the platform decision contract
  evaluates inside the STS at token-exchange time.
sidebar:
  order: 8
slug: v0.2/concepts/policy
---
...
Every evaluation receives documented Application, Resource, action, Session, Delegation, requested-scope, optional Subject-claim, Approval, and trace context. Use [Author Policy Data](/v0.2/guides/author-policy/) for the current field-level contract.
...
Read [Mandates](/v0.2/concepts/mandate/) to understand the short-lived proof an allowed exchange produces.
