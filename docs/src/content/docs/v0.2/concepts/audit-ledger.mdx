...
sidebar:
  order: 14
slug: v0.2/concepts/audit-ledger
---
...
| Delegation              | Creation, traversal, impact, and revocation.                          |
...
Use [Guides](/v0.2/guides/) when you are ready to apply the model.

## Related Pages

* [Tail and Query the Audit Stream](/v0.2/guides/audit-stream/)
* [Trace One Protected Request](/v0.2/tutorials/inspect-a-run/)
* [Operations](/v0.2/operations/)
