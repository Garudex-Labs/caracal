---
title: Release Map
description: Lockstep SemVer mapping for packages, images, binaries, chart,
  release records, and documentation.
pageType: reference
slug: v0.2/reference/release-package-runtime-map
---

## Repository Release Surfaces

`release.config.json` `product.version` is authoritative. The current source state is `0.2.0-rc.3`; successive release candidates increment `-rc.N`.
...
Use [Wire Contracts](/v0.2/reference/interoperability-contracts/) when validating SDK, adapter, exporter, or provider-plugin compatibility.
