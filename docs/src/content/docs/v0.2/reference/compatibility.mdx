---
title: Compatibility
description: Supported runtimes, deployment targets, version combinations, and
  v0.2 stability rules.
pageType: reference
slug: v0.2/reference/compatibility
---
...
Use [Release Map](/v0.2/reference/release-package-runtime-map/) to map product versions to packages, images, and release surfaces.

## Related Pages

* [Release Map](/v0.2/reference/release-package-runtime-map/)
* [Deploy with Helm](/v0.2/operations/kubernetes-helm/)
* [Set Up Locally](/v0.2/contributing/setup/)
