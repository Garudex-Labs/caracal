...
description: Map supported callers to runtime services and identify the
  dependency behind each visible failure.
pageType: architecture
slug: v0.2/architecture/system-topology
---
...
Use [Choose a Deployment Profile](/v0.2/operations/deployment-profiles/) for deployment choices and [Understand Services](/v0.2/services/) for service-specific failure posture.
