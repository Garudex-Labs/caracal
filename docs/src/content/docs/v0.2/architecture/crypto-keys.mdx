---
title: Manage Keys
description: Map each key to the boundary it protects and plan rotation without
  breaking issuance, verification, or evidence.
pageType: architecture
slug: v0.2/architecture/crypto-keys
---
...
Use [Rotate Keys and Secrets](/v0.2/operations/key-management/) for the operational procedure and [Configure Secret Backends](/v0.2/operations/secret-backends/) for custody options.
