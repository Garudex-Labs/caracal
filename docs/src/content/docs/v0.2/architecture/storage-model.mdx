---
title: Store State
description: Decide what to back up, what can be replayed, and what must never
  be treated as an application API.
pageType: architecture
slug: v0.2/architecture/storage-model
---
...
Use [Back Up and Retain Data](/v0.2/operations/backup-retention/) for procedures. Do not use direct SQL as a management or migration shortcut.

## Next Step

[Manage Keys](/v0.2/architecture/crypto-keys/).
