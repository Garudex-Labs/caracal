---
title: Overview
description: Learn what problem Caracal solves and how it works in plain
  language, then follow the shortest path to your first protected, audited call.
pageType: landing
slug: v0.2/get-started
---
