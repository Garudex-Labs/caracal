...
description: Understand the evidence pipeline, supported read surfaces, delayed
  delivery, integrity failures, and recovery signals.
pageType: reference
slug: v0.2/services/audit
---
...
Do not send application audit records to these routes. Caracal services publish the signed event contract. Service environment variables are cataloged in [Configure Service Environment](/v0.2/operations/env-vars/).
...
Use [Audit and Request Traces](/v0.2/concepts/audit-ledger/) for evidence semantics and [Configure Alerts](/v0.2/operations/alerts/) for thresholds.

## Next Step

[Automate Management](/v0.2/services/control/) when a trusted remote client needs product-management automation.
