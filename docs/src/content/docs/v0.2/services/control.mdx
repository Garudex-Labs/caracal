...
description: Decide when to enable the optional Control API and understand its
  credential, gate, replay, scope, and audit dependencies.
pageType: reference
slug: v0.2/services/control
---
...
For exact payload examples, scopes, reconciliation documents, and error envelopes, use [Use the Admin API](/v0.2/api/control-plane/) and [Bootstrap Control State](/v0.2/examples/control-bootstrap/).
...
[Choose the Right Surface](/v0.2/runtime-console/cli-and-console/) for the complete boundary or [Enforce Boundaries](/v0.2/architecture/trust-boundaries/) for trust placement.
