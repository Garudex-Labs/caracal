...
description: Start local Caracal services, distinguish health from readiness,
  open the packaged console, and reset state deliberately.
pageType: workflow
slug: v0.2/runtime-console/stack
---

The stack is the set of containers `caracal up` manages: Caracal's services, PostgreSQL, Redis, and the packaged web console. This page covers its day-to-day lifecycle; [Install Caracal](/v0.2/get-started/install-caracal/) covers getting the CLI and Docker in place.
...
For infrastructure diagnosis, use [Debug Infrastructure Issues](/v0.2/operations/debugging/).
...
[Control Console Access](/v0.2/runtime-console/console-access/).
