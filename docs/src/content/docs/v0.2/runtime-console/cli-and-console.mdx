...
description: Route each lifecycle, human-management, automation, and workload
  task to its supported Caracal surface.
pageType: workflow
slug: v0.2/runtime-console/cli-and-console
---
