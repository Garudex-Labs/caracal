...
pageType: workflow
slug: v0.2/security/hardening
---

Use after operational hardening and before production traffic. [Harden Production](/v0.2/operations/tls-hardening/) configures the environment; this page verifies the security boundaries actually hold in it.
...
Verify artifacts with [Verify a Release](/v0.2/security/verify-releases/).
