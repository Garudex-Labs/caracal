...
description: Review the canonical OSS threat model, validate boundaries, and
  record residual risk.
pageType: workflow
slug: v0.2/security/threat-model
---
...
Apply [Harden Security Posture](/v0.2/security/hardening/).
