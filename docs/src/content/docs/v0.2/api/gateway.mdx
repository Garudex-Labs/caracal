...
description: Protected reverse-proxy behavior, routing headers, denial checks,
  and upstream forwarding.
pageType: api
slug: v0.2/api/gateway
---
...
Continue to [Use Event Topics](/v0.2/api/event-topics/) to understand the Redis Stream topics that carry audit, invalidation, revocation, and Session lifecycle events.

## Related Pages

* [Protect Upstreams](/v0.2/services/gateway/)
* [Enforce Boundaries](/v0.2/architecture/trust-boundaries/)
