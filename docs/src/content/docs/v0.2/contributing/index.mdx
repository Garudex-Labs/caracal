...
description: Contributor guide for local setup, project standards, workflow,
  validation, governance, and releases.
pageType: landing
slug: v0.2/contributing
---
...
| Need                                            | Page                                             |
| ----------------------------------------------- | ------------------------------------------------ |
| Prepare your machine                            | [Set Up Locally](/v0.2/contributing/setup/)           |
| Learn project boundaries and naming conventions | [Follow Project Standards](/v0.2/contributing/style/) |
| Work on an issue or pull request                | [Make a Change](/v0.2/contributing/workflow/)         |
| Run the right checks                            | [Validate Changes](/v0.2/contributing/testing/)       |

## Maintainer Path

| Need                                               | Page                                               |
| -------------------------------------------------- | -------------------------------------------------- |
| Understand review, ownership, and security process | [Understand Governance](/v0.2/contributing/governance/) |
| Prepare, publish, or recover a release             | [Release Caracal](/v0.2/contributing/release/)          |

## Before You Start

* File bugs, documentation gaps, and feature requests through the [issue templates](https://github.com/Garudex-Labs/caracal/issues/new/choose). A small focused fix can go straight to a pull request; medium and larger changes start with an issue or proposal before code, as sized in [Contribution Scale](/v0.2/contributing/governance/#contribution-scale).
* Report suspected vulnerabilities through [Report a Vulnerability](/v0.2/security/disclosure/), never in public issues.
...
* Toolchain versions are pinned in [Set Up Locally](/v0.2/contributing/setup/#prerequisites); no prior knowledge of the repository is assumed beyond those tools.

## Next Step

Start with [Set Up Locally](/v0.2/contributing/setup/) before making source changes.
