...
description: Maintainer ownership, contribution process, security process, and
  community expectations.
pageType: reference
slug: v0.2/contributing/governance
---
...
Security concerns must be reported through [Report a Vulnerability](/v0.2/security/disclosure/). Public issues are not appropriate for vulnerabilities, credential exposure, unsafe execution, or exploitable operational failures.

## Next Step

Maintainers preparing a cut should use [Release Caracal](/v0.2/contributing/release/).

## Related Pages

* [Make a Change](/v0.2/contributing/workflow/)
* [Review the Threat Model](/v0.2/security/threat-model/)
* [Respond to Incidents](/v0.2/operations/incident-response/)
