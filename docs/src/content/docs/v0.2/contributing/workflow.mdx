...
Do not discuss suspected vulnerabilities in public issues. Use GitHub private advisories or the email path in [Report a Vulnerability](/v0.2/security/disclosure/).

## Next Step

Use [Validate Changes](/v0.2/contributing/testing/) to choose the narrowest useful test command before opening a pull request.
