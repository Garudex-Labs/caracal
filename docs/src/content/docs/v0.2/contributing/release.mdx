...
description: Lockstep SemVer releases, package publishing, protected workflows,
  and rollback rules.
pageType: reference
slug: v0.2/contributing/release
---
...
* [Release Map](/v0.2/reference/release-package-runtime-map/)
* [Upgrade Caracal](/v0.2/operations/upgrade/)
