...
pageType: reference
slug: v0.2/contributing/testing
---
...
After validation, review [Understand Governance](/v0.2/contributing/governance/) for contribution scale, review ownership, and private security process.
