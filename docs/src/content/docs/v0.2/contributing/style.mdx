...
description: Repository conventions for code, docs, naming, command ownership,
  and product boundaries.
pageType: reference
slug: v0.2/contributing/style
---
...
Use [Make a Change](/v0.2/contributing/workflow/) to plan and submit a focused pull request.
