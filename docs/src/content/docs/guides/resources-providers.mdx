...
| Gateway application | The managed Caracal application identity Gateway uses for upstream exchanges. DCR applications cannot be bound here — they are short-lived single-session credentials, not durable Gateway identities. |
