...
Every decision is written to the zone audit ledger with the application, session, Session, and delegation chain. The customer id rides in the agent metadata and labels you set in Steps 2 and 3, so you can answer "what did this customer do, with what authority" from the audit trail. See [Audit and Request Traces](/concepts/audit-ledger/).
