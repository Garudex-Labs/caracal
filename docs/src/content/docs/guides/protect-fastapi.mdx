...
For every middleware field, use [ASGI Adapter reference](/sdks/adapters/asgi/).

## Next step

Replace the in-memory store with the Redis backend and run the revocation case in [Test Caracal Integrations](/guides/testing/).
