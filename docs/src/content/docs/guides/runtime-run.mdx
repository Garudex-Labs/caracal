...
| Request denied | Check grant, policy-set activation, scopes, and audit diagnostics. |

Related pages: [Quickstart](/get-started/quickstart/), [First Integration](/get-started/first-integration/), and [Audit Ledger](/concepts/audit-ledger/).
