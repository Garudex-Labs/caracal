...
Use `caracalai-fastmcp` when a Python FastMCP app should reject invalid, expired, insufficient, or revoked Caracal mandates.
...
Related pages: [Protect an MCP Server](/guides/protect-mcp/) and [Human Approval](/guides/step-up/).
