...
import (
	...
	nethttpadapter "github.com/garudex-labs/caracal/packages/adapters/nethttp/go"
...
func main() {
	...
	protected := nethttpadapter.VerifierMiddleware(verifier.Require(verify.Options{
		RequiredScopes:  []string{"tickets:read"},
		RequiredTargets: []string{"https://api.example.com/tickets"},
	}))(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		claims, ok := nethttpadapter.ClaimsFromContext(r.Context())
		if !ok {
