...
For exact Go fields, use [net/http Adapter reference](/sdks/adapters/nethttp/).

## Next step

Connect the Redis revocation consumer and validate it with [Test Caracal Integrations](/guides/testing/).
