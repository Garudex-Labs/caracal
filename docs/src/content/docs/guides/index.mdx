...
| Configure authority | [Define Resources and Providers](/guides/resources-providers/), [Issue Grants and Invitations](/guides/grants-invitations/), [Author a Rego Policy](/guides/author-policy/), and [Activate a Policy Set](/guides/activate-policy-set/) |
...
```mermaid
flowchart LR
  Resource["Define resources"] --> Grant["Issue grants"]
  Grant --> Policy["Author policy"]
...
| Console | Human-facing zone, application, provider, resource, policy, grant, session, audit, explanation, delegation, diagnostic, and credential workflows. |
