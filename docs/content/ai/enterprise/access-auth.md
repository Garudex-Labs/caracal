---
id: ai-enterprise-access-auth
title: Access and Auth
slug: /ai/enterprise/access-auth
sidebar_label: Access and Auth
canonical_human: /enterprise/access-auth
...
> Canonical human page: [/enterprise/access-auth](/enterprise/access-auth)

## Definition

Deterministic machine-facing contract for access and auth in the `/ai/enterprise/access-auth` route scope.
...
- [/enterprise/access-auth](/enterprise/access-auth)
