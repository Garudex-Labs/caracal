...
Deterministic configuration contract for `environment-variables` runtime settings.
...
```json
{
  "operation": "apply_environment_variables_config",
  "apply_status": "ok",
  "effective_config": {
    "scope": "dev"
  }
...
- [/open-source/end-users/configuration/environment-variables](/open-source/end-users/configuration/environment-variables)
