---
id: ai-open-source-end-users-configuration-logging
title: logging
slug: /ai/open-source/end-users/configuration/logging
sidebar_label: logging
canonical_human: /open-source/end-users/configuration/logging
applies_to: [oss]
edition: oss
audience: ai
page_type: reference
...
> Canonical human page: [/open-source/end-users/configuration/logging](/open-source/end-users/configuration/logging)

## Definition

Deterministic configuration contract for `logging` runtime settings.
...
```json
{
  "operation": "apply_logging_config",
  "apply_status": "ok",
  "effective_config": {
    "scope": "dev"
  }
...
- [/open-source/end-users/configuration/logging](/open-source/end-users/configuration/logging)
