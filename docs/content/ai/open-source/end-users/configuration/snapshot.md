---
id: ai-open-source-end-users-configuration-snapshot
title: snapshot
slug: /ai/open-source/end-users/configuration/snapshot
sidebar_label: snapshot
canonical_human: /open-source/end-users/configuration/snapshot
applies_to: [oss]
edition: oss
audience: ai
page_type: reference
...
> Canonical human page: [/open-source/end-users/configuration/snapshot](/open-source/end-users/configuration/snapshot)

## Definition

Deterministic configuration contract for `snapshot` runtime settings.
...
```json
{
  "operation": "apply_snapshot_config",
  "apply_status": "ok",
  "effective_config": {
    "scope": "dev"
  }
...
- [/open-source/end-users/configuration/snapshot](/open-source/end-users/configuration/snapshot)
