---
id: ai-open-source-end-users-configuration-redis
title: redis
slug: /ai/open-source/end-users/configuration/redis
sidebar_label: redis
canonical_human: /open-source/end-users/configuration/redis
applies_to: [oss]
edition: oss
audience: ai
page_type: reference
...
> Canonical human page: [/open-source/end-users/configuration/redis](/open-source/end-users/configuration/redis)

## Definition

Deterministic configuration contract for `redis` runtime settings.
...
- [/open-source/end-users/configuration/redis](/open-source/end-users/configuration/redis)
