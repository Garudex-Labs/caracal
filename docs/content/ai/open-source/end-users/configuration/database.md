---
id: ai-open-source-end-users-configuration-database
title: database
slug: /ai/open-source/end-users/configuration/database
sidebar_label: database
canonical_human: /open-source/end-users/configuration/database
applies_to: [oss]
edition: oss
audience: ai
page_type: reference
...
> Canonical human page: [/open-source/end-users/configuration/database](/open-source/end-users/configuration/database)

## Definition

Deterministic configuration contract for `database` runtime settings.
...
```json
{
  "operation": "apply_database_config",
  "apply_status": "ok",
  "effective_config": {
    "scope": "dev"
  }
...
- [/open-source/end-users/configuration/database](/open-source/end-users/configuration/database)
