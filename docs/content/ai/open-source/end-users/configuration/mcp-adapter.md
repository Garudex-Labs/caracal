---
id: ai-open-source-end-users-configuration-mcp-adapter
title: mcp_adapter
slug: /ai/open-source/end-users/configuration/mcp-adapter
sidebar_label: mcp_adapter
canonical_human: /open-source/end-users/configuration/mcp-adapter
applies_to: [oss]
edition: oss
audience: ai
page_type: reference
...
> Canonical human page: [/open-source/end-users/configuration/mcp-adapter](/open-source/end-users/configuration/mcp-adapter)

## Definition

Deterministic configuration contract for `mcp-adapter` runtime settings.
...
```json
{
  "operation": "apply_mcp_adapter_config",
  "apply_status": "ok",
  "effective_config": {
    "scope": "dev"
  }
...
- [/open-source/end-users/configuration/mcp-adapter](/open-source/end-users/configuration/mcp-adapter)
