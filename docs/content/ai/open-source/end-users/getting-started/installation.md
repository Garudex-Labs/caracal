---
id: ai-open-source-end-users-getting-started-installation
title: Install Caracal
slug: /ai/open-source/end-users/getting-started/installation
sidebar_label: Install Caracal
canonical_human: /open-source/end-users/getting-started/installation
applies_to: [oss]
edition: oss
audience: ai
page_type: task
...
> Canonical human page: [/open-source/end-users/getting-started/installation](/open-source/end-users/getting-started/installation)

## Definition

Deterministic machine-facing contract for install caracal in the `/ai/open-source/end-users/getting-started/installation` route scope.

## Inputs

| name | type | required | source | notes |
| --- | --- | --- | --- | --- |
| Workspace context | object | yes | README.md | Workspace and principal scope for evaluation. |
| Authority context | object | conditional | README.md | Policy, mandate, and delegation data when required. |
| Operation payload | map | yes | README.md | Route-specific fields with canonical identifiers. |
...
- [/open-source/end-users/getting-started/installation](/open-source/end-users/getting-started/installation)
