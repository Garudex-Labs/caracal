---
id: ai-open-source-end-users-troubleshooting-logs
title: Read Runtime Logs
slug: /ai/open-source/end-users/troubleshooting/logs
sidebar_label: Read Runtime Logs
canonical_human: /open-source/end-users/troubleshooting/logs
applies_to: [oss]
edition: oss
audience: ai
page_type: task
...
# Read Runtime Logs (AI)

> Canonical human page: [/open-source/end-users/troubleshooting/logs](/open-source/end-users/troubleshooting/logs)

## Definition

Deterministic machine-facing contract for read runtime logs in the `/ai/open-source/end-users/troubleshooting/logs` route scope.
...
- [/open-source/end-users/troubleshooting/logs](/open-source/end-users/troubleshooting/logs)
