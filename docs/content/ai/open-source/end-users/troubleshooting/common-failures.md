---
id: ai-open-source-end-users-troubleshooting-common-failures
title: Common Failures
slug: /ai/open-source/end-users/troubleshooting/common-failures
sidebar_label: Common Failures
canonical_human: /open-source/end-users/troubleshooting/common-failures
applies_to: [oss]
edition: oss
audience: ai
page_type: reference
...
> Canonical human page: [/open-source/end-users/troubleshooting/common-failures](/open-source/end-users/troubleshooting/common-failures)

## Definition

Deterministic machine-facing contract for common failures in the `/ai/open-source/end-users/troubleshooting/common-failures` route scope.

## Inputs

| name | type | required | source | notes |
| --- | --- | --- | --- | --- |
| Workspace context | object | yes | packages/caracal-server/caracal/exceptions.py | Workspace and principal scope for evaluation. |
| Authority context | object | conditional | packages/caracal-server/caracal/exceptions.py | Policy, mandate, and delegation data when required. |
| Operation payload | map | yes | packages/caracal-server/caracal/exceptions.py | Route-specific fields with canonical identifiers. |
...
- [/open-source/end-users/troubleshooting/common-failures](/open-source/end-users/troubleshooting/common-failures)
