---
id: ai-open-source-end-users-troubleshooting-reset-vs-purge
title: Reset vs Purge
slug: /ai/open-source/end-users/troubleshooting/reset-vs-purge
sidebar_label: Reset vs Purge
canonical_human: /open-source/end-users/troubleshooting/reset-vs-purge
applies_to: [oss]
edition: oss
audience: ai
page_type: concept
...
> Canonical human page: [/open-source/end-users/troubleshooting/reset-vs-purge](/open-source/end-users/troubleshooting/reset-vs-purge)

## Definition

Deterministic machine-facing contract for reset vs purge in the `/ai/open-source/end-users/troubleshooting/reset-vs-purge` route scope.
...
- [/open-source/end-users/troubleshooting/reset-vs-purge](/open-source/end-users/troubleshooting/reset-vs-purge)
