---
id: ai-open-source-end-users-tui-common-tasks
title: Common Flow Tasks
slug: /ai/open-source/end-users/tui/common-tasks
sidebar_label: Common Flow Tasks
canonical_human: /open-source/end-users/tui/common-tasks
applies_to: [oss]
edition: oss
audience: ai
page_type: task
...
# Common Flow Tasks (AI)

> Canonical human page: [/open-source/end-users/tui/common-tasks](/open-source/end-users/tui/common-tasks)

## Definition

Deterministic machine-facing contract for common flow tasks in the `/ai/open-source/end-users/tui/common-tasks` route scope.

## Inputs

| name | type | required | source | notes |
| --- | --- | --- | --- | --- |
| Workspace context | object | yes | packages/caracal-server/caracal/flow/ | Workspace and principal scope for evaluation. |
| Authority context | object | conditional | packages/caracal-server/caracal/flow/ | Policy, mandate, and delegation data when required. |
| Operation payload | map | yes | packages/caracal-server/caracal/flow/ | Route-specific fields with canonical identifiers. |
...
- [/open-source/end-users/tui/common-tasks](/open-source/end-users/tui/common-tasks)
