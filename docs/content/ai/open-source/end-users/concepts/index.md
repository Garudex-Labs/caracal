---
id: ai-open-source-end-users-concepts-index
title: Concepts
slug: /ai/open-source/end-users/concepts
sidebar_label: Concepts
canonical_human: /open-source/end-users/concepts
applies_to: [oss]
edition: oss
audience: ai
page_type: hub
...
> Canonical human page: [/open-source/end-users/concepts](/open-source/end-users/concepts)

## Definition

Deterministic machine-facing contract for concepts in the `/ai/open-source/end-users/concepts` route scope.

## Inputs

| name | type | required | source | notes |
| --- | --- | --- | --- | --- |
| Workspace context | object | yes | ABBREVIATIONS.md | Workspace and principal scope for evaluation. |
| Authority context | object | conditional | ABBREVIATIONS.md | Policy, mandate, and delegation data when required. |
| Operation payload | map | yes | ABBREVIATIONS.md | Route-specific fields with canonical identifiers. |
...
- [/open-source/end-users/concepts](/open-source/end-users/concepts)
