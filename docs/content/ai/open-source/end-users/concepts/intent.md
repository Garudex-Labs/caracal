---
id: ai-open-source-end-users-concepts-intent
title: Intent
slug: /ai/open-source/end-users/concepts/intent
sidebar_label: Intent
canonical_human: /open-source/end-users/concepts/intent
applies_to: [oss]
edition: oss
audience: ai
page_type: concept
...
source_files:
  - packages/caracal-server/caracal/core/intent.py
---

# Intent (AI)

> Canonical human page: [/open-source/end-users/concepts/intent](/open-source/end-users/concepts/intent)

## Definition

Deterministic machine-facing contract for intent in the `/ai/open-source/end-users/concepts/intent` route scope.

## Inputs

| name | type | required | source | notes |
| --- | --- | --- | --- | --- |
| Workspace context | object | yes | packages/caracal-server/caracal/core/intent.py | Workspace and principal scope for evaluation. |
| Authority context | object | conditional | packages/caracal-server/caracal/core/intent.py | Policy, mandate, and delegation data when required. |
| Operation payload | map | yes | packages/caracal-server/caracal/core/intent.py | Route-specific fields with canonical identifiers. |
...
- [/open-source/end-users/concepts/intent](/open-source/end-users/concepts/intent)
