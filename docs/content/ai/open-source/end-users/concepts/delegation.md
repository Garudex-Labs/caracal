---
id: ai-open-source-end-users-concepts-delegation
title: Delegation
slug: /ai/open-source/end-users/concepts/delegation
sidebar_label: Delegation
canonical_human: /open-source/end-users/concepts/delegation
applies_to: [oss]
edition: oss
audience: ai
page_type: concept
...
source_files:
  - packages/caracal-server/caracal/core/delegation.py
  - core/delegation_graph.py
---

# Delegation (AI)

> Canonical human page: [/open-source/end-users/concepts/delegation](/open-source/end-users/concepts/delegation)

## Definition

Deterministic machine-facing contract for delegation in the `/ai/open-source/end-users/concepts/delegation` route scope.

## Inputs

| name | type | required | source | notes |
| --- | --- | --- | --- | --- |
| Workspace context | object | yes | packages/caracal-server/caracal/core/delegation.py | Workspace and principal scope for evaluation. |
| Authority context | object | conditional | packages/caracal-server/caracal/core/delegation.py | Policy, mandate, and delegation data when required. |
| Operation payload | map | yes | packages/caracal-server/caracal/core/delegation.py | Route-specific fields with canonical identifiers. |
...
- [/open-source/end-users/concepts/delegation](/open-source/end-users/concepts/delegation)
