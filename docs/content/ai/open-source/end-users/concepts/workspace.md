---
id: ai-open-source-end-users-concepts-workspace
title: Workspace
slug: /ai/open-source/end-users/concepts/workspace
sidebar_label: Workspace
canonical_human: /open-source/end-users/concepts/workspace
applies_to: [oss]
edition: oss
audience: ai
page_type: concept
...
source_files:
  - packages/caracal-server/caracal/flow/workspace.py
  - deployment/config_manager.py
---

# Workspace (AI)

> Canonical human page: [/open-source/end-users/concepts/workspace](/open-source/end-users/concepts/workspace)

## Definition

Deterministic machine-facing contract for workspace in the `/ai/open-source/end-users/concepts/workspace` route scope.

## Inputs

| name | type | required | source | notes |
| --- | --- | --- | --- | --- |
| Workspace context | object | yes | packages/caracal-server/caracal/flow/workspace.py | Workspace and principal scope for evaluation. |
| Authority context | object | conditional | packages/caracal-server/caracal/flow/workspace.py | Policy, mandate, and delegation data when required. |
| Operation payload | map | yes | packages/caracal-server/caracal/flow/workspace.py | Route-specific fields with canonical identifiers. |
...
- [/open-source/end-users/concepts/workspace](/open-source/end-users/concepts/workspace)
