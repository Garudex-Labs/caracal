---
id: ai-open-source-end-users-concepts-principal
title: Principal
slug: /ai/open-source/end-users/concepts/principal
sidebar_label: Principal
canonical_human: /open-source/end-users/concepts/principal
applies_to: [oss]
edition: oss
audience: ai
page_type: concept
...
source_files:
  - packages/caracal-server/caracal/core/identity.py
  - core/principal_keys.py
  - cli/principal.py
---

# Principal (AI)

> Canonical human page: [/open-source/end-users/concepts/principal](/open-source/end-users/concepts/principal)

## Definition

Deterministic machine-facing contract for principal in the `/ai/open-source/end-users/concepts/principal` route scope.

## Inputs

| name | type | required | source | notes |
| --- | --- | --- | --- | --- |
| Workspace context | object | yes | packages/caracal-server/caracal/core/identity.py | Workspace and principal scope for evaluation. |
| Authority context | object | conditional | packages/caracal-server/caracal/core/identity.py | Policy, mandate, and delegation data when required. |
| Operation payload | map | yes | packages/caracal-server/caracal/core/identity.py | Route-specific fields with canonical identifiers. |
...
- [/open-source/end-users/concepts/principal](/open-source/end-users/concepts/principal)
