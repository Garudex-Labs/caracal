---
id: ai-open-source-end-users-concepts-caveat
title: Caveat
slug: /ai/open-source/end-users/concepts/caveat
sidebar_label: Caveat
canonical_human: /open-source/end-users/concepts/caveat
applies_to: [oss]
edition: oss
audience: ai
page_type: concept
...
source_files:
  - packages/caracal-server/caracal/core/caveat_chain.py
---

# Caveat (AI)

> Canonical human page: [/open-source/end-users/concepts/caveat](/open-source/end-users/concepts/caveat)

## Definition

Deterministic machine-facing contract for caveat in the `/ai/open-source/end-users/concepts/caveat` route scope.

## Inputs

| name | type | required | source | notes |
| --- | --- | --- | --- | --- |
| Workspace context | object | yes | packages/caracal-server/caracal/core/caveat_chain.py | Workspace and principal scope for evaluation. |
| Authority context | object | conditional | packages/caracal-server/caracal/core/caveat_chain.py | Policy, mandate, and delegation data when required. |
| Operation payload | map | yes | packages/caracal-server/caracal/core/caveat_chain.py | Route-specific fields with canonical identifiers. |
...
- [/open-source/end-users/concepts/caveat](/open-source/end-users/concepts/caveat)
