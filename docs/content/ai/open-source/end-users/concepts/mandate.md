...
Deterministic machine-facing contract for mandate in the `/ai/open-source/end-users/concepts/mandate` route scope.
...
- [/open-source/end-users/concepts/mandate](/open-source/end-users/concepts/mandate)
