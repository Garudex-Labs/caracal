...
Deterministic machine-facing contract for ai service runtime isolation (ais) in the `/ai/open-source/end-users/concepts/ai-service-isolation` route scope.
...
```json
{
  "operation": "ai-service-isolation",
  "status": "ok",
  "result": {
    "id": "example-id"
  },
...
- [/open-source/end-users/concepts/ai-service-isolation](/open-source/end-users/concepts/ai-service-isolation)
