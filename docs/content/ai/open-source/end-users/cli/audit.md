---
id: ai-open-source-end-users-cli-audit
title: audit
slug: /ai/open-source/end-users/cli/audit
sidebar_label: audit
canonical_human: /open-source/end-users/cli/audit
applies_to: [oss]
edition: oss
audience: ai
page_type: reference
...
> Canonical human page: [/open-source/end-users/cli/audit](/open-source/end-users/cli/audit)

## Definition

Deterministic machine-facing contract for `audit` CLI operations.
...
- [/open-source/end-users/cli/audit](/open-source/end-users/cli/audit)
