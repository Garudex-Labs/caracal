---
id: ai-open-source-end-users-cli-policy
title: policy
slug: /ai/open-source/end-users/cli/policy
sidebar_label: policy
canonical_human: /open-source/end-users/cli/policy
applies_to: [oss]
edition: oss
audience: ai
page_type: reference
...
> Canonical human page: [/open-source/end-users/cli/policy](/open-source/end-users/cli/policy)

## Definition

Deterministic machine-facing contract for `policy` CLI operations.
...
- [/open-source/end-users/cli/policy](/open-source/end-users/cli/policy)
