---
id: ai-open-source-end-users-cli-principal
title: principal
slug: /ai/open-source/end-users/cli/principal
sidebar_label: principal
canonical_human: /open-source/end-users/cli/principal
applies_to: [oss]
edition: oss
audience: ai
page_type: reference
...
> Canonical human page: [/open-source/end-users/cli/principal](/open-source/end-users/cli/principal)

## Definition

Deterministic machine-facing contract for `principal` CLI operations.
...
- [/open-source/end-users/cli/principal](/open-source/end-users/cli/principal)
