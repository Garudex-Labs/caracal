---
id: ai-open-source-end-users-cli-provider
title: provider
slug: /ai/open-source/end-users/cli/provider
sidebar_label: provider
canonical_human: /open-source/end-users/cli/provider
applies_to: [oss]
edition: oss
audience: ai
page_type: reference
...
source_files:
  - packages/caracal-server/caracal/cli/provider_scopes.py
  - provider/definitions.py
---

# provider (AI)

> Canonical human page: [/open-source/end-users/cli/provider](/open-source/end-users/cli/provider)

## Definition

Deterministic machine-facing contract for `provider` CLI operations.
...
- [/open-source/end-users/cli/provider](/open-source/end-users/cli/provider)
