---
id: ai-open-source-end-users-cli-delegation
title: delegation
slug: /ai/open-source/end-users/cli/delegation
sidebar_label: delegation
canonical_human: /open-source/end-users/cli/delegation
applies_to: [oss]
edition: oss
audience: ai
page_type: reference
...
> Canonical human page: [/open-source/end-users/cli/delegation](/open-source/end-users/cli/delegation)

## Definition

Deterministic machine-facing contract for `delegation` CLI operations.
...
- [/open-source/end-users/cli/delegation](/open-source/end-users/cli/delegation)
