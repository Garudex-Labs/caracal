---
id: ai-open-source-end-users-cli-workspace
title: workspace
slug: /ai/open-source/end-users/cli/workspace
sidebar_label: workspace
canonical_human: /open-source/end-users/cli/workspace
applies_to: [oss]
edition: oss
audience: ai
page_type: reference
...
source_files:
  - packages/caracal-server/caracal/cli/ (workspace command file)
---

# workspace (AI)

> Canonical human page: [/open-source/end-users/cli/workspace](/open-source/end-users/cli/workspace)

## Definition

Deterministic machine-facing contract for `workspace` CLI operations.
...
- [/open-source/end-users/cli/workspace](/open-source/end-users/cli/workspace)
