---
id: ai-open-source-end-users-cli-doctor
title: doctor
slug: /ai/open-source/end-users/cli/doctor
sidebar_label: doctor
canonical_human: /open-source/end-users/cli/doctor
applies_to: [oss]
edition: oss
audience: ai
page_type: reference
...
> Canonical human page: [/open-source/end-users/cli/doctor](/open-source/end-users/cli/doctor)

## Definition

Deterministic machine-facing contract for `doctor` CLI operations.
...
- [/open-source/end-users/cli/doctor](/open-source/end-users/cli/doctor)
