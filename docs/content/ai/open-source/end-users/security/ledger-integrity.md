---
id: ai-open-source-end-users-security-ledger-integrity
title: Ledger Integrity
slug: /ai/open-source/end-users/security/ledger-integrity
sidebar_label: Ledger Integrity
canonical_human: /open-source/end-users/security/ledger-integrity
applies_to: [oss]
edition: oss
audience: ai
page_type: concept
...
source_files:
  - packages/caracal-server/caracal/merkle/
---

# Ledger Integrity (AI)

> Canonical human page: [/open-source/end-users/security/ledger-integrity](/open-source/end-users/security/ledger-integrity)

## Definition

Deterministic machine-facing contract for ledger integrity in the `/ai/open-source/end-users/security/ledger-integrity` route scope.

## Inputs

| name | type | required | source | notes |
| --- | --- | --- | --- | --- |
| Workspace context | object | yes | packages/caracal-server/caracal/merkle/ | Workspace and principal scope for evaluation. |
| Authority context | object | conditional | packages/caracal-server/caracal/merkle/ | Policy, mandate, and delegation data when required. |
| Operation payload | map | yes | packages/caracal-server/caracal/merkle/ | Route-specific fields with canonical identifiers. |
...
- [/open-source/end-users/security/ledger-integrity](/open-source/end-users/security/ledger-integrity)
