---
id: ai-open-source-end-users-workflows-issue-a-mandate
title: Issue a Mandate
slug: /ai/open-source/end-users/workflows/issue-a-mandate
sidebar_label: Issue a Mandate
canonical_human: /open-source/end-users/workflows/issue-a-mandate
applies_to: [oss]
edition: oss
audience: ai
page_type: task
...
> Canonical human page: [/open-source/end-users/workflows/issue-a-mandate](/open-source/end-users/workflows/issue-a-mandate)

## Definition

Deterministic machine-facing contract for issue a mandate in the `/ai/open-source/end-users/workflows/issue-a-mandate` route scope.

## Inputs

| name | type | required | source | notes |
| --- | --- | --- | --- | --- |
| Workspace context | object | yes | packages/caracal-server/caracal/cli/authority.py | Workspace and principal scope for evaluation. |
| Authority context | object | conditional | packages/caracal-server/caracal/cli/authority.py | Policy, mandate, and delegation data when required. |
| Operation payload | map | yes | packages/caracal-server/caracal/cli/authority.py | Route-specific fields with canonical identifiers. |
...
- [/open-source/end-users/workflows/issue-a-mandate](/open-source/end-users/workflows/issue-a-mandate)
