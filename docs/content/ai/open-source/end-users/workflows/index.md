---
id: ai-open-source-end-users-workflows-index
title: Workflows
slug: /ai/open-source/end-users/workflows
sidebar_label: Workflows
canonical_human: /open-source/end-users/workflows
applies_to: [oss]
edition: oss
audience: ai
page_type: hub
...
> Canonical human page: [/open-source/end-users/workflows](/open-source/end-users/workflows)

## Definition

Deterministic machine-facing contract for workflows in the `/ai/open-source/end-users/workflows` route scope.
...
- [/open-source/end-users/workflows](/open-source/end-users/workflows)
