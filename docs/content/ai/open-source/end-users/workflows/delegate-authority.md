---
id: ai-open-source-end-users-workflows-delegate-authority
title: Delegate Authority
slug: /ai/open-source/end-users/workflows/delegate-authority
sidebar_label: Delegate Authority
canonical_human: /open-source/end-users/workflows/delegate-authority
applies_to: [oss]
edition: oss
audience: ai
page_type: task
...
source_files:
  - packages/caracal-server/caracal/cli/delegation.py
---

# Delegate Authority (AI)

> Canonical human page: [/open-source/end-users/workflows/delegate-authority](/open-source/end-users/workflows/delegate-authority)

## Definition

Deterministic machine-facing contract for delegate authority in the `/ai/open-source/end-users/workflows/delegate-authority` route scope.

## Inputs

| name | type | required | source | notes |
| --- | --- | --- | --- | --- |
| Workspace context | object | yes | packages/caracal-server/caracal/cli/delegation.py | Workspace and principal scope for evaluation. |
| Authority context | object | conditional | packages/caracal-server/caracal/cli/delegation.py | Policy, mandate, and delegation data when required. |
| Operation payload | map | yes | packages/caracal-server/caracal/cli/delegation.py | Route-specific fields with canonical identifiers. |
...
- [/open-source/end-users/workflows/delegate-authority](/open-source/end-users/workflows/delegate-authority)
