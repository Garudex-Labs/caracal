---
id: ai-open-source-end-users-workflows-revoke-a-mandate
title: Revoke a Mandate
slug: /ai/open-source/end-users/workflows/revoke-a-mandate
sidebar_label: Revoke a Mandate
canonical_human: /open-source/end-users/workflows/revoke-a-mandate
applies_to: [oss]
edition: oss
audience: ai
page_type: task
...
> Canonical human page: [/open-source/end-users/workflows/revoke-a-mandate](/open-source/end-users/workflows/revoke-a-mandate)

## Definition

Deterministic machine-facing contract for revoke a mandate in the `/ai/open-source/end-users/workflows/revoke-a-mandate` route scope.
...
- [/open-source/end-users/workflows/revoke-a-mandate](/open-source/end-users/workflows/revoke-a-mandate)
