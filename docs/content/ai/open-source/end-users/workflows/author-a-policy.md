---
id: ai-open-source-end-users-workflows-author-a-policy
title: Author a Policy
slug: /ai/open-source/end-users/workflows/author-a-policy
sidebar_label: Author a Policy
canonical_human: /open-source/end-users/workflows/author-a-policy
applies_to: [oss]
edition: oss
audience: ai
page_type: task
...
source_files:
  - packages/caracal-server/caracal/cli/authority_policy.py
---

# Author a Policy (AI)

> Canonical human page: [/open-source/end-users/workflows/author-a-policy](/open-source/end-users/workflows/author-a-policy)

## Definition

Deterministic machine-facing contract for author a policy in the `/ai/open-source/end-users/workflows/author-a-policy` route scope.

## Inputs

| name | type | required | source | notes |
| --- | --- | --- | --- | --- |
| Workspace context | object | yes | packages/caracal-server/caracal/cli/authority_policy.py | Workspace and principal scope for evaluation. |
| Authority context | object | conditional | packages/caracal-server/caracal/cli/authority_policy.py | Policy, mandate, and delegation data when required. |
| Operation payload | map | yes | packages/caracal-server/caracal/cli/authority_policy.py | Route-specific fields with canonical identifiers. |
...
- [/open-source/end-users/workflows/author-a-policy](/open-source/end-users/workflows/author-a-policy)
