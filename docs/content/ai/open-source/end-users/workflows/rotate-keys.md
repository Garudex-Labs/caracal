---
id: ai-open-source-end-users-workflows-rotate-keys
title: Rotate Keys
slug: /ai/open-source/end-users/workflows/rotate-keys
sidebar_label: Rotate Keys
canonical_human: /open-source/end-users/workflows/rotate-keys
applies_to: [oss]
edition: oss
audience: ai
page_type: task
...
> Canonical human page: [/open-source/end-users/workflows/rotate-keys](/open-source/end-users/workflows/rotate-keys)

## Definition

Deterministic machine-facing contract for rotate keys in the `/ai/open-source/end-users/workflows/rotate-keys` route scope.
...
- [/open-source/end-users/workflows/rotate-keys](/open-source/end-users/workflows/rotate-keys)
