---
id: ai-open-source-end-users-workflows-register-a-principal
title: Register a Principal
slug: /ai/open-source/end-users/workflows/register-a-principal
sidebar_label: Register a Principal
canonical_human: /open-source/end-users/workflows/register-a-principal
applies_to: [oss]
edition: oss
audience: ai
page_type: task
...
source_files:
  - packages/caracal-server/caracal/cli/principal.py
---

# Register a Principal (AI)

> Canonical human page: [/open-source/end-users/workflows/register-a-principal](/open-source/end-users/workflows/register-a-principal)

## Definition

Deterministic machine-facing contract for register a principal in the `/ai/open-source/end-users/workflows/register-a-principal` route scope.

## Inputs

| name | type | required | source | notes |
| --- | --- | --- | --- | --- |
| Workspace context | object | yes | packages/caracal-server/caracal/cli/principal.py | Workspace and principal scope for evaluation. |
| Authority context | object | conditional | packages/caracal-server/caracal/cli/principal.py | Policy, mandate, and delegation data when required. |
| Operation payload | map | yes | packages/caracal-server/caracal/cli/principal.py | Route-specific fields with canonical identifiers. |
...
```json
{
  "operation": "register-a-principal",
  "status": "ok",
  "result": {
    "id": "example-id"
  },
...
- [/open-source/end-users/workflows/register-a-principal](/open-source/end-users/workflows/register-a-principal)
