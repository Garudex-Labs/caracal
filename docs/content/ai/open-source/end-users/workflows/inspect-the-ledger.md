---
id: ai-open-source-end-users-workflows-inspect-the-ledger
title: Inspect the Ledger
slug: /ai/open-source/end-users/workflows/inspect-the-ledger
sidebar_label: Inspect the Ledger
canonical_human: /open-source/end-users/workflows/inspect-the-ledger
applies_to: [oss]
edition: oss
audience: ai
page_type: task
...
source_files:
  - packages/caracal-server/caracal/cli/authority_ledger.py
---

# Inspect the Ledger (AI)

> Canonical human page: [/open-source/end-users/workflows/inspect-the-ledger](/open-source/end-users/workflows/inspect-the-ledger)

## Definition

Deterministic machine-facing contract for inspect the ledger in the `/ai/open-source/end-users/workflows/inspect-the-ledger` route scope.

## Inputs

| name | type | required | source | notes |
| --- | --- | --- | --- | --- |
| Workspace context | object | yes | packages/caracal-server/caracal/cli/authority_ledger.py | Workspace and principal scope for evaluation. |
| Authority context | object | conditional | packages/caracal-server/caracal/cli/authority_ledger.py | Policy, mandate, and delegation data when required. |
| Operation payload | map | yes | packages/caracal-server/caracal/cli/authority_ledger.py | Route-specific fields with canonical identifiers. |
...
- [/open-source/end-users/workflows/inspect-the-ledger](/open-source/end-users/workflows/inspect-the-ledger)
