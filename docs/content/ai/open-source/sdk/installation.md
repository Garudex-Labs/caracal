---
id: ai-open-source-sdk-installation
title: SDK Installation
slug: /ai/open-source/sdk/installation
sidebar_label: SDK Installation
canonical_human: /open-source/sdk/installation
applies_to: [oss]
edition: oss
audience: ai
page_type: task
...
source_files:
  ...
  - sdk/node-sdk/package.json
---

# SDK Installation (AI)

> Canonical human page: [/open-source/sdk/installation](/open-source/sdk/installation)

## Definition

Deterministic machine-facing contract for sdk installation in the `/ai/open-source/sdk/installation` route scope.

## Inputs

| name | type | required | source | notes |
| --- | --- | --- | --- | --- |
| Workspace context | object | yes | sdk/python-sdk/pyproject.toml | Workspace and principal scope for evaluation. |
| Authority context | object | conditional | sdk/python-sdk/pyproject.toml | Policy, mandate, and delegation data when required. |
| Operation payload | map | yes | sdk/python-sdk/pyproject.toml | Route-specific fields with canonical identifiers. |
...
- [/open-source/sdk/installation](/open-source/sdk/installation)
