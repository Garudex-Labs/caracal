---
id: ai-open-source-sdk-reference-error-taxonomy
title: Error Taxonomy
slug: /ai/open-source/sdk/reference/error-taxonomy
sidebar_label: Error Taxonomy
canonical_human: /open-source/sdk/reference/error-taxonomy
applies_to: [oss]
edition: oss
audience: ai
page_type: reference
...
> Canonical human page: [/open-source/sdk/reference/error-taxonomy](/open-source/sdk/reference/error-taxonomy)

## Definition

Deterministic machine-facing contract for error taxonomy in the `/ai/open-source/sdk/reference/error-taxonomy` route scope.

## Inputs

| name | type | required | source | notes |
| --- | --- | --- | --- | --- |
| Workspace context | object | yes | sdk/python-sdk/src/caracal_sdk/_compat.py | Workspace and principal scope for evaluation. |
| Authority context | object | conditional | sdk/python-sdk/src/caracal_sdk/_compat.py | Policy, mandate, and delegation data when required. |
| Operation payload | map | yes | sdk/python-sdk/src/caracal_sdk/_compat.py | Route-specific fields with canonical identifiers. |
...
- [/open-source/sdk/reference/error-taxonomy](/open-source/sdk/reference/error-taxonomy)
