...
Deterministic machine-facing contract for hook points in the `/ai/open-source/sdk/reference/hook-points` route scope.

## Inputs

| name | type | required | source | notes |
| --- | --- | --- | --- | --- |
| Workspace context | object | yes | sdk/python-sdk/src/caracal_sdk/hooks.py | Workspace and principal scope for evaluation. |
| Authority context | object | conditional | sdk/python-sdk/src/caracal_sdk/hooks.py | Policy, mandate, and delegation data when required. |
| Operation payload | map | yes | sdk/python-sdk/src/caracal_sdk/hooks.py | Route-specific fields with canonical identifiers. |
...
- [/open-source/sdk/reference/hook-points](/open-source/sdk/reference/hook-points)
