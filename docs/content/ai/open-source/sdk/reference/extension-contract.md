---
id: ai-open-source-sdk-reference-extension-contract
title: Extension Contract
slug: /ai/open-source/sdk/reference/extension-contract
sidebar_label: Extension Contract
canonical_human: /open-source/sdk/reference/extension-contract
applies_to: [oss]
edition: oss
audience: ai
page_type: reference
...
source_files:
  - sdk/python-sdk/src/caracal_sdk/extensions.py
  - sdk/node-sdk/src/extensions.ts
---

# Extension Contract (AI)

> Canonical human page: [/open-source/sdk/reference/extension-contract](/open-source/sdk/reference/extension-contract)

## Definition

Deterministic machine-facing contract for extension contract in the `/ai/open-source/sdk/reference/extension-contract` route scope.

## Inputs

| name | type | required | source | notes |
| --- | --- | --- | --- | --- |
| Workspace context | object | yes | sdk/python-sdk/src/caracal_sdk/extensions.py | Workspace and principal scope for evaluation. |
| Authority context | object | conditional | sdk/python-sdk/src/caracal_sdk/extensions.py | Policy, mandate, and delegation data when required. |
| Operation payload | map | yes | sdk/python-sdk/src/caracal_sdk/extensions.py | Route-specific fields with canonical identifiers. |
...
- [/open-source/sdk/reference/extension-contract](/open-source/sdk/reference/extension-contract)
