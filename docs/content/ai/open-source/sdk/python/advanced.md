---
id: ai-open-source-sdk-python-advanced
title: Python Advanced
slug: /ai/open-source/sdk/python/advanced
sidebar_label: Python Advanced
canonical_human: /open-source/sdk/python/advanced
applies_to: [oss]
edition: oss
audience: ai
page_type: reference
...
> Canonical human page: [/open-source/sdk/python/advanced](/open-source/sdk/python/advanced)

## Definition

Deterministic machine-facing contract for python advanced in the `/ai/open-source/sdk/python/advanced` route scope.

## Inputs

| name | type | required | source | notes |
| --- | --- | --- | --- | --- |
| Workspace context | object | yes | sdk/python-sdk/src/caracal_sdk/client.py | Workspace and principal scope for evaluation. |
| Authority context | object | conditional | sdk/python-sdk/src/caracal_sdk/client.py | Policy, mandate, and delegation data when required. |
| Operation payload | map | yes | sdk/python-sdk/src/caracal_sdk/client.py | Route-specific fields with canonical identifiers. |
...
- [/open-source/sdk/python/advanced](/open-source/sdk/python/advanced)
