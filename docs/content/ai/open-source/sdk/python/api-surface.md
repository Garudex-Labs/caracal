...
Deterministic machine-facing contract for python api surface in the `/ai/open-source/sdk/python/api-surface` route scope.

## Inputs

| name | type | required | source | notes |
| --- | --- | --- | --- | --- |
| Workspace context | object | yes | sdk/python-sdk/src/caracal_sdk/__init__.py | Workspace and principal scope for evaluation. |
| Authority context | object | conditional | sdk/python-sdk/src/caracal_sdk/__init__.py | Policy, mandate, and delegation data when required. |
| Operation payload | map | yes | sdk/python-sdk/src/caracal_sdk/__init__.py | Route-specific fields with canonical identifiers. |
...
- [/open-source/sdk/python/api-surface](/open-source/sdk/python/api-surface)
