---
id: ai-open-source-sdk-python-examples
title: Python Examples
slug: /ai/open-source/sdk/python/examples
sidebar_label: Python Examples
canonical_human: /open-source/sdk/python/examples
applies_to: [oss]
edition: oss
audience: ai
page_type: task
...
> Canonical human page: [/open-source/sdk/python/examples](/open-source/sdk/python/examples)

## Definition

Deterministic machine-facing contract for python examples in the `/ai/open-source/sdk/python/examples` route scope.

## Inputs

| name | type | required | source | notes |
| --- | --- | --- | --- | --- |
| Workspace context | object | yes | sdk/python-sdk/ | Workspace and principal scope for evaluation. |
| Authority context | object | conditional | sdk/python-sdk/ | Policy, mandate, and delegation data when required. |
| Operation payload | map | yes | sdk/python-sdk/ | Route-specific fields with canonical identifiers. |
...
- [/open-source/sdk/python/examples](/open-source/sdk/python/examples)
