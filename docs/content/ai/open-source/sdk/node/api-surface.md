---
id: ai-open-source-sdk-node-api-surface
title: Node API Surface
slug: /ai/open-source/sdk/node/api-surface
sidebar_label: Node API Surface
canonical_human: /open-source/sdk/node/api-surface
applies_to: [oss]
edition: oss
audience: ai
page_type: reference
...
> Canonical human page: [/open-source/sdk/node/api-surface](/open-source/sdk/node/api-surface)

## Definition

Deterministic machine-facing contract for node api surface in the `/ai/open-source/sdk/node/api-surface` route scope.

## Inputs

| name | type | required | source | notes |
| --- | --- | --- | --- | --- |
| Workspace context | object | yes | sdk/node-sdk/src/index.ts | Workspace and principal scope for evaluation. |
| Authority context | object | conditional | sdk/node-sdk/src/index.ts | Policy, mandate, and delegation data when required. |
| Operation payload | map | yes | sdk/node-sdk/src/index.ts | Route-specific fields with canonical identifiers. |
...
- [/open-source/sdk/node/api-surface](/open-source/sdk/node/api-surface)
