---
id: ai-open-source-sdk-node-advanced
title: Node Advanced
slug: /ai/open-source/sdk/node/advanced
sidebar_label: Node Advanced
canonical_human: /open-source/sdk/node/advanced
applies_to: [oss]
edition: oss
audience: ai
page_type: reference
...
> Canonical human page: [/open-source/sdk/node/advanced](/open-source/sdk/node/advanced)

## Definition

Deterministic machine-facing contract for node advanced in the `/ai/open-source/sdk/node/advanced` route scope.
...
- [/open-source/sdk/node/advanced](/open-source/sdk/node/advanced)
