...
Deterministic machine-facing contract for node sdk usage in the `/ai/open-source/sdk/node/usage` route scope.

## Inputs

| name | type | required | source | notes |
| --- | --- | --- | --- | --- |
| Workspace context | object | yes | sdk/node-sdk/src/client.ts | Workspace and principal scope for evaluation. |
| Authority context | object | conditional | sdk/node-sdk/src/client.ts | Policy, mandate, and delegation data when required. |
| Operation payload | map | yes | sdk/node-sdk/src/client.ts | Route-specific fields with canonical identifiers. |
...
- [/open-source/sdk/node/usage](/open-source/sdk/node/usage)
