---
id: ai-open-source-developers-core-authority-system
title: Core Authority System
slug: /ai/open-source/developers/core-authority-system
sidebar_label: Core Authority System
canonical_human: /open-source/developers/core-authority-system
applies_to: [oss]
edition: oss
audience: ai
page_type: concept
...
source_files:
  - packages/caracal-server/caracal/core/
---

# Core Authority System (AI)

> Canonical human page: [/open-source/developers/core-authority-system](/open-source/developers/core-authority-system)

## Definition

Deterministic machine-facing contract for core authority system in the `/ai/open-source/developers/core-authority-system` route scope.

## Inputs

| name | type | required | source | notes |
| --- | --- | --- | --- | --- |
| Workspace context | object | yes | packages/caracal-server/caracal/core/ | Workspace and principal scope for evaluation. |
| Authority context | object | conditional | packages/caracal-server/caracal/core/ | Policy, mandate, and delegation data when required. |
| Operation payload | map | yes | packages/caracal-server/caracal/core/ | Route-specific fields with canonical identifiers. |
...
```json
{
  "operation": "core-authority-system",
  "status": "ok",
  "result": {
    "id": "example-id"
  },
...
- [/open-source/developers/core-authority-system](/open-source/developers/core-authority-system)
