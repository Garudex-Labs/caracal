---
id: ai-open-source-developers-runtime-model
title: Runtime Model
slug: /ai/open-source/developers/runtime-model
sidebar_label: Runtime Model
canonical_human: /open-source/developers/runtime-model
applies_to: [oss]
edition: oss
audience: ai
page_type: concept
...
> Canonical human page: [/open-source/developers/runtime-model](/open-source/developers/runtime-model)

## Definition

Deterministic machine-facing contract for runtime model in the `/ai/open-source/developers/runtime-model` route scope.
...
- [/open-source/developers/runtime-model](/open-source/developers/runtime-model)
