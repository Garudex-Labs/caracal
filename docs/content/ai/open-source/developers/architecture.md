---
id: ai-open-source-developers-architecture
title: Architecture
slug: /ai/open-source/developers/architecture
sidebar_label: Architecture
canonical_human: /open-source/developers/architecture
applies_to: [oss]
edition: oss
audience: ai
page_type: concept
...
> Canonical human page: [/open-source/developers/architecture](/open-source/developers/architecture)

## Definition

Deterministic machine-facing contract for architecture in the `/ai/open-source/developers/architecture` route scope.

## Inputs

| name | type | required | source | notes |
| --- | --- | --- | --- | --- |
| Workspace context | object | yes | packages/ | Workspace and principal scope for evaluation. |
| Authority context | object | conditional | packages/ | Policy, mandate, and delegation data when required. |
| Operation payload | map | yes | packages/ | Route-specific fields with canonical identifiers. |
...
- [/open-source/developers/architecture](/open-source/developers/architecture)
