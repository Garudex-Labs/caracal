...
| Layer | Roles | Scope |
| --- | --- |
| Deployment | `user`, `reviewer`, `operator` | Instance operation, public registry review, user administration, audit/security-event reads, settings, diagnostics |
