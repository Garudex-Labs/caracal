  ...
  integrations: [
    ...
    starlight({
      ...
      sidebar: [
        ...
        {
          label: 'Runtime and Terminal Management',
          collapsed: true,
          items: [
            { label: 'Overview', link: '/runtime-terminal/' },
            { label: 'Runtime Lifecycle', link: '/runtime-terminal/stack/' },
            { label: 'Runtime Execution', link: '/runtime-terminal/runtime/' },
            { label: 'Management Workflows', link: '/runtime-terminal/admin/' },
            { label: 'Observability Workflows', link: '/runtime-terminal/observability/' },
            { label: 'Agents and Delegation', link: '/runtime-terminal/agents/' },
            { label: 'Configuration File', link: '/runtime-terminal/config-file/' },
            { label: 'Terminal Management Interface', link: '/runtime-terminal/terminal/' },
          ],
        },
        {
          label: 'Services',
