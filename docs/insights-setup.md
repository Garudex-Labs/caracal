...
The AI engine uses [LiteLLM](https://docs.litellm.ai/docs/providers) to call LLMs for report generation. This means any LiteLLM-compatible provider works out of the box.

## Quick Start

1. Go to **Operator > AI Engine** as a deployment operator
