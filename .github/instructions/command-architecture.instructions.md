---
description: "Use when changing Caracal commands, package scripts, Consoles, shell launchers, command catalogs, completions, or command documentation. Enforces the runtime-script versus product-management boundary."
applyTo: "{package.json,apps/runtime/**,apps/console/**,packages/engine/src/commands.ts,packages/engine/src/dispatch.ts,docs/**,README.md,CONTRIBUTING.md}"
---
...
- If the Console is unavailable, the top-level shell must still expose lifecycle commands.
