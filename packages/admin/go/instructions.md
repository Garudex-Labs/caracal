...
## Architecture Design
- The module exposes `ControlClient`, `AdminClient` (provisioning and operations surfaces), identifier helpers, and the `Ensure` reconciler family in one package, mirroring the `@caracalai/admin` TypeScript surface.
