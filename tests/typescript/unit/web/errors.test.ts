...
import { ERROR_CATALOG, FALLBACK_ERROR_CODE, errorEntry } from '../../../../apps/web/src/platform/errors/catalog.ts'
import { HttpError, errorToStatus, isHttpError } from '../../../../apps/web/src/platform/errors/httpError.ts'
