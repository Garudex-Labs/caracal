...
test.describe("Kiro Full Lifecycle E2E", () => {
  ...
  test("Step 4: Verify the project intelligence briefing reflects Kiro data", async ({ page }) => {
    await loginToWebUI(page);
    ...
    await page.screenshot({ path: "e2e-results/kiro-intelligence-briefing.png" });
  });
});
