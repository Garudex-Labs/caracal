...
class TestLoggingConfiguration:
    ...
    def test_log_delegation_token_validation_success(self, temp_dir: Path):
        ...
        log_delegation_token_validation(
            logger,
            source_principal_id="parent-123",
            target_principal_id="child-456",
            success=True
        )
        ...
        assert log_entry["source_principal_id"] == "parent-123"
        assert log_entry["target_principal_id"] == "child-456"
