...
Test helpers that resolve caracal source files across the host and server wheels.
"""
...
def caracal_path(*subparts: str) -> Path:
    """Resolve a path under the caracal/ source tree across all contributing wheels."""
