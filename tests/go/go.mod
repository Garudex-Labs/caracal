...
require (
	github.com/garudex-labs/caracal/packages/adapters/nethttp/go v0.1.6-rc.3
	github.com/garudex-labs/caracal/packages/core/go v0.1.6-rc.3
	...
	github.com/garudex-labs/caracal/packages/verify/go v0.1.6-rc.3
