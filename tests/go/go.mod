...
require (
	...
	github.com/garudex-labs/caracal/packages/identity/go v1.0.0
	github.com/garudex-labs/caracal/packages/revocation/go v1.0.0
	github.com/garudex-labs/caracal/packages/verify/go v1.0.0
