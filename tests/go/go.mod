...
require (
	github.com/garudex-labs/caracal/packages/adapters/nethttp/go v0.2.0-rc.2
	github.com/garudex-labs/caracal/packages/core/go v0.2.0-rc.2
	...
	github.com/garudex-labs/caracal/packages/verify/go v0.2.0-rc.2
