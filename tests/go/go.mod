...
require (
	github.com/garudex-labs/caracal/packages/adapters/nethttp/go v0.2.0-rc.6
	github.com/garudex-labs/caracal/packages/core/go v0.2.0-rc.6
	github.com/garudex-labs/caracal/packages/identity/go v0.2.0-rc.6
	github.com/garudex-labs/caracal/packages/revocation/go v0.2.0-rc.6
	github.com/garudex-labs/caracal/packages/verify/go v0.2.0-rc.6
