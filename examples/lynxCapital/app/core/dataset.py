...
REGIONS: dict[str, Region] = {
    "US": Region(
        id="US", name="North America", currency="USD", rails=[Rail.ACH, Rail.WIRE]
    ),
    "IN": Region(
        id="IN", name="India", currency="INR", rails=[Rail.NEFT, Rail.RTGS, Rail.SWIFT]
    ),
    "DE": Region(
        id="DE", name="Europe", currency="EUR", rails=[Rail.SEPA, Rail.SWIFT, Rail.WIRE]
    ),
    "SG": Region(
        id="SG",
        name="Southeast Asia",
