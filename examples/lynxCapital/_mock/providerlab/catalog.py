...
CATALOG: tuple[Provider, ...] = (
    ...
    Provider(
        ...
        tagline="Enterprise vendors, purchase orders, item receipts, bills, three-way match, payments, and ledger",
        resources=(
            "vendors",
            "purchase_orders",
            "item_receipts",
    ...
    Provider(
        id="tallyhall-books",
        brand="Tallyhall Books",
        category="oauth2_authorization_code",
        protocol="rest",
        port=9404,
        industry="SMB accounting",
    ...
    Provider(
        id="aegis-screening",
        brand="Aegis Screening",
        category="caracal_mandate",
        protocol="rest",
        port=9407,
        industry="Compliance / AML",
    ...
    Provider(
        id="verafin-monitor",
        brand="Verafin Monitor",
        category="caracal_mandate",
        protocol="rest",
        port=9408,
        industry="Regulatory / RegTech",
    ...
    Provider(
        id="lumen-identity",
        brand="Lumen Identity",
        category="none",
        protocol="rest",
        port=9409,
        industry="Identity / directory",
    ...
    Provider(
        ...
        port=9410,
        industry="CRM",
        tagline="Customer and vendor relationship management: accounts, contacts, deal pipeline, owners, and activities",
        resources=(
            "contacts",
            "accounts",
            "deals",
    ...
    Provider(
        id="atlas-vendor",
        brand="Atlas Vendor Network",
        category="mcp",
        protocol="mcp",
        port=9411,
        industry="Vendor master data",
    ...
    Provider(
        ...
        apikey_location="header",
        apikey_field="X-Api-Key",
        sdk_package="sabre_tax",
    ),
    Provider(
        id="quetzal-payouts",
        brand="Quetzal Payouts",
        category="sdk",
        protocol="sdk",
        port=9414,
        industry="Mass payouts",
    ...
    Provider(
        ...
        port=9415,
        industry="Messaging",
        tagline="Transactional email and SMS with templates, message streams, delivery tracking, suppressions, and webhooks",
        resources=(
            "messages",
            "templates",
            "message_streams",
...
def taxonomy_complete() -> bool:
    ...
    protos = all(
        len(BY_PROTOCOL[p]) >= 1 for p in ("rest", "grpc", "mcp", "sse", "sdk")
    )
