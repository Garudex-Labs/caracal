...
CATALOG: tuple[Provider, ...] = (
    ...
    Provider(
        ...
        resources=("entities", "screenings", "watchlist_hits", "cases",
                   "audit_events", "monitors", "watchlists", "whitelist"),
    ...
    Provider(
        ...
        tagline="Real-time FX quotes, OHLC bars, conversions, movers, end-of-day reference fixings, and streaming rate subscriptions",
