...
describe('real-provider example contract', () => {
  ...
  it('documents real providers and resource mappings', async () => {
    ...
    assert.match(readme, /runtime\/<workload_id>\/secret/)
    assert.match(readme, /Launcher\*\* page/)
    assert.match(readme, /CARACAL_WORKLOAD_SECRET/)
  ...
  it('ships a bootstrap-only environment example', async () => {
    ...
    assert.match(envExample, /CARACAL_WORKLOAD_ID/)
