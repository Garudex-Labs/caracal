...
#
# Standalone Windows installer that downloads, verifies, and extracts the Caracal runtime CLI release archive.
...
Write-Ok 'Caracal runtime is installed'
