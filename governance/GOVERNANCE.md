...
Caracal is maintained by Garudex Labs. The maintainers listed in `.github/MAINTAINERS` are the primary decision-makers for the project. They review changes in their areas, triage issues, enforce repository standards, and approve releases. The governance process is designed to stay transparent and predictable in most day-to-day actions.

Small changes may be submitted directly through pull requests. Medium-sized issues and bugs should first be opened as GitHub issues with a clear description, context, and expected outcome. Larger work should be broken down into an issue plus smaller sub-issues so it can be reviewed and implemented in manageable parts. Architectural changes, cross-cutting refactors, and security-sensitive work should follow a more structured process, including problem statement, proposal, alternatives, trade-offs, and open questions.
...
Any questions about process, contribution flow, or ownership can be discussed on Caracal’s Discord.