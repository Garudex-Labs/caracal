...
function buildTree(spans: Span[]): SpanNode[] {
  ...
  for (const node of map.values()) {
    const parent = node.span.parent_span_id ? map.get(node.span.parent_span_id) : undefined;
    // Guard self-parented spans: a cycle here would recurse forever in render.
