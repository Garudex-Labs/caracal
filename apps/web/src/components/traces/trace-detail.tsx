...
/** Span payloads are JSON when structured but may be plain text; never crash the render on them. */
function jsonViewSrc(value: unknown): unknown {
              ...
              <div className="space-y-4">
                ...
                {selectedSpan.input != null && (
                  <Card><CardHeader className="py-2 px-4"><CardTitle className="text-sm">Input</CardTitle></CardHeader>
                    <CardContent className="px-4 pb-3"><JsonView src={jsonViewSrc(selectedSpan.input)} collapsed={2} /></CardContent>
                  </Card>
                )}
                {selectedSpan.output != null && (
                  <Card><CardHeader className="py-2 px-4"><CardTitle className="text-sm">Output</CardTitle></CardHeader>
                    <CardContent className="px-4 pb-3"><JsonView src={jsonViewSrc(selectedSpan.output)} collapsed={2} /></CardContent>
                  </Card>
                )}
                {selectedSpan.error && (
