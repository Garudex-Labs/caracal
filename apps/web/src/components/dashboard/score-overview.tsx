...
export const DIMENSION_META: Record<string, { label: string; color: string; hidden?: boolean }> = {
  goal_completion: { label: "Goal Completion", color: "bg-success" },
  tool_efficiency: { label: "Tool Efficiency", color: "bg-primary" },
  tool_failures: { label: "Tool Failures", color: "bg-warning" },
