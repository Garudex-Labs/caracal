...
## Architecture Design
- `src/main.ts` boots Fastify, wires shutdown, and refuses to start unless the engine-managed runtime sets `CARACAL_CONTROL_ENABLED=true`.
...
- Must not document direct environment-variable enablement as a management path.
