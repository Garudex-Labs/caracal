...
function allowlistHelp(): never {
  return showHelp([
    ...
    '',
    'Controls which emails may register and sign in on the web console. Changes',
    'apply live. Entries are exact emails or @domain suffixes; while the list is',
    'empty, registration is open in development and closed in production.',
    '',
    'Subcommands:',
