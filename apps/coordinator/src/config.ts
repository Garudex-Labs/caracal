...
function buildCfg() {
  ...
  return {
    ...
    relayIntervalMs: intEnv('RELAY_INTERVAL_MS', 1_000),
    relayClaimIdleMs: intEnv('RELAY_CLAIM_IDLE_SEC', 60) * 1_000,
    relayConsumerName: getenv('RELAY_CONSUMER_NAME', getenv('HOSTNAME', 'coordinator-relay-0')),
