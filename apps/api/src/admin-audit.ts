...
const COLLECTION_SEGMENT =
  /^(zones|applications|workloads|resources|providers|provider-connections|policies|policy-sets|policy-templates|grants|subject-issuers|subjects|approvals|admin-tokens|operator-conversations)$/
