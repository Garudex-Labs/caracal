  ...
  return [
    {
      ...
      content: systemPrompt(
        ...
        [
          ...
          'callers reach directly, without routing through the Gateway. You may propose connectProvider for',
          ...
          'resource "using this provider" or an existing provider plans ONLY the defineResource step - a',
          'resource step never collects credentials, and binding the resource to its provider is console',
          'wiring, not a new provider.',
          'Your executable surface connects providers and defines the resource and its',
