...
const CARACAL_PLATFORM = [
  ...
  'Typed constraints bound a Delegation: resource, scopes, TTL, and hop count. Approval and broad-reason',
  'fields are audit metadata; usage rate limits, quotas, and verifier chain requirements are separate.',
