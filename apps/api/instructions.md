...
- Must treat Operator memory surfaces (zone memory, session facts, recent turns) as activity history only: they record what was done and what is going on, never whether an object exists now.
