...
variable "domain_name" {
  description = "Public hostname for the install (e.g. caracal.example.com). Leave empty to use Cloud Run default URL."
  type        = string
  default     = ""
}
...
variable "auth_cpu" {
  description = "CPU allocation for the identity service."
  type        = string
  default     = "1"
}

variable "auth_memory" {
  description = "Memory allocation for the identity service."
  type        = string
  default     = "512Mi"
}

variable "auth_min_instances" {
  description = "Minimum instances for the identity service."
  type        = number
  default     = 1
}

variable "auth_max_instances" {
  description = "Maximum instances for the identity service."
  type        = number
  default     = 3
}
