...
locals {
  ...
  presets = {
    small = {
      ...
      auth_autoscale_min  = 1
      auth_autoscale_max  = 2
    ...
    medium = {
      ...
      auth_autoscale_min  = 2
      auth_autoscale_max  = 4
  ...
  effective_auth_cpu            = local.use_preset ? local.presets[var.sizing].auth_cpu : var.auth_cpu
  effective_auth_memory         = local.use_preset ? local.presets[var.sizing].auth_memory : var.auth_memory
  effective_auth_desired_count  = local.use_preset ? local.presets[var.sizing].auth_desired_count : var.auth_desired_count
  effective_auth_autoscale_min  = local.use_preset ? local.presets[var.sizing].auth_autoscale_min : var.auth_autoscale_min
  effective_auth_autoscale_max  = local.use_preset ? local.presets[var.sizing].auth_autoscale_max : var.auth_autoscale_max
